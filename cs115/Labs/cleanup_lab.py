...
class Hero(Actor):
    ...
    def __init__(self, image_file, fire_image_file, center=False, speed=200):
        ...
        super().__init__(image_file,center, speed)
        # Create a member variable called fire_image that loads the image from
        # the disk where the Hero is on fire.
        self.fire_image = pygame.image.load(fire_image_file).convert_alpha()
